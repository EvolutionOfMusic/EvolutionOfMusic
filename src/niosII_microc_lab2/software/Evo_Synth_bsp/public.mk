...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../niosII_microc_lab2.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x11090a8
SOPC_SYSID_FLAG += --sidp=0x11090a8
ELF_PATCH_FLAG  += --sidp 0x11090a8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1458772264
SOPC_SYSID_FLAG += --timestamp=1458772264
ELF_PATCH_FLAG  += --timestamp 1458772264
