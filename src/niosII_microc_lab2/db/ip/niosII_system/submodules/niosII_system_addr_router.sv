...
(
    ...
    localparam PAD5 = log2ceil(64'h11090a0 - 64'h1109090);
    localparam PAD6 = log2ceil(64'h11090b8 - 64'h11090b4);
    // -------------------------------------------------------
    ...
    always @* begin
        ...
        // ( 0x1109090 .. 0x11090a0 )
        if ( {address[RG:PAD5],{PAD5{1'b0}}} == 25'h1109090 ) begin
            src_channel = 11'b0010000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 4;
        end

        // ( 0x11090b4 .. 0x11090b8 )
        if ( {address[RG:PAD6],{PAD6{1'b0}}} == 25'h11090b4 ) begin
