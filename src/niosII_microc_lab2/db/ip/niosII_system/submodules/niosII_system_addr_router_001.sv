...
(
    ...
    localparam PAD6 = log2ceil(64'h1109080 - 64'h1109060);
    localparam PAD7 = log2ceil(64'h11090a0 - 64'h1109090);
    localparam PAD8 = log2ceil(64'h11090a8 - 64'h11090a0);
    localparam PAD9 = log2ceil(64'h11090b0 - 64'h11090a8);
    localparam PAD10 = log2ceil(64'h11090b8 - 64'h11090b4);
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h11090b8;
    ...
    always @* begin
        ...
        // ( 0x1109090 .. 0x11090a0 )
        if ( {address[RG:PAD7],{PAD7{1'b0}}} == 25'h1109090 ) begin
            src_channel = 11'b00000010000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 4;
        end

        // ( 0x11090a0 .. 0x11090a8 )
        if ( {address[RG:PAD8],{PAD8{1'b0}}} == 25'h11090a0 ) begin
            src_channel = 11'b01000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 9;
        end

        // ( 0x11090a8 .. 0x11090b0 )
        if ( {address[RG:PAD9],{PAD9{1'b0}}} == 25'h11090a8 ) begin
            src_channel = 11'b00010000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 7;
        end

        // ( 0x11090b4 .. 0x11090b8 )
        if ( {address[RG:PAD10],{PAD10{1'b0}}} == 25'h11090b4 ) begin
