...
# Fri Mar 18 15:54:19 MDT 2016
# DO NOT MODIFY


# 
# synthesizer "synthesizer" v1.0
# null 2016.03.18.15:54:19
# 
# 
...
set_interface_property reset associatedClock clock_sink_1
...
set_interface_property voice_select associatedClock clock_sink_1
...
set_interface_property audio associatedClock clock_sink_1
...
add_interface_port clock_sink_1 csi_clk50M clk Input 1
...
add_interface_port clock_sink_2 csi_clk32k clk Input 1
