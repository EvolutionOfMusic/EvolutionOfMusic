...
# ACDS 12.1sp1 243 linux 2016.03.23.15:56:08
...
alias dev_com {
  echo "\[exec\] dev_com"
  vlog +define+SKIP_KEYWORDS_PRAGMA "/OPT/altera/12.1/tools/quartus/eda/sim_lib/altera_primitives.v"              -work altera_ver      
  ...
  vlog                              "/OPT/altera/12.1/tools/quartus/eda/sim_lib/altera_lnsim.sv"                  -work altera_lnsim_ver
...
alias elab {
  echo "\[exec\] elab"
  vsim +access +r  -t ps -L work -L up_clocks_0 -L audio_and_video_config_0 -L audio_0 -L gate_timer -L sram_0 -L sdram_0 -L jtag_uart_0 -L timer_0 -L sysid_qsys_0 -L onchip_memory2_0 -L nios2_qsys_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneii_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneii $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  vsim -dbg -O2 +access +r -t ps -L work -L up_clocks_0 -L audio_and_video_config_0 -L audio_0 -L gate_timer -L sram_0 -L sdram_0 -L jtag_uart_0 -L timer_0 -L sysid_qsys_0 -L onchip_memory2_0 -L nios2_qsys_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneii_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneii $TOP_LEVEL_NAME
}
