...
--synthesis_resources = 
 ...
 ENTITY  niosII_system_burst_adapter_002 IS 
	 ...
	 ( 
		 ...
		 sink0_data	:	IN  STD_LOGIC_VECTOR (72 DOWNTO 0);
		 sink0_endofpacket	:	IN  STD_LOGIC;
		 sink0_ready	:	OUT  STD_LOGIC;
		 sink0_startofpacket	:	IN  STD_LOGIC;
		 sink0_valid	:	IN  STD_LOGIC;
		 source0_channel	:	OUT  STD_LOGIC_VECTOR (12 DOWNTO 0);
		 source0_data	:	OUT  STD_LOGIC_VECTOR (72 DOWNTO 0);
 ...
 END niosII_system_burst_adapter_002;
 ...
 BEGIN
	...
	source0_channel <= ( sink0_channel(12 DOWNTO 0));
	source0_data <= ( sink0_data(72 DOWNTO 43) & "0" & "0" & "1" & sink0_data(39 DOWNTO 0));
	source0_endofpacket <= sink0_endofpacket;
	source0_startofpacket <= sink0_startofpacket;
	source0_valid <= sink0_valid;

 END RTL; --niosII_system_burst_adapter_002
