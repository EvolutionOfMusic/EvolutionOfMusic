...
--synthesis_resources = lut 9 mux21 12 oper_add 1 
 ...
 ENTITY  niosII_system_cmd_xbar_mux IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END niosII_system_cmd_xbar_mux;

 ARCHITECTURE RTL OF niosII_system_cmd_xbar_mux IS

	 ATTRIBUTE synthesis_clearbox : natural;
	 ATTRIBUTE synthesis_clearbox OF RTL : ARCHITECTURE IS 1;
	 SIGNAL	niosii_system_cmd_xbar_mux_saved_grant_0_32q	:	STD_LOGIC := '0';
	 SIGNAL	niosii_system_cmd_xbar_mux_saved_grant_1_31q	:	STD_LOGIC := '0';
	 ...
	 SIGNAL	niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_0_748q	:	STD_LOGIC := '0';
	 SIGNAL	niosii_system_cmd_xbar_mux_share_count_zero_flag_30q	:	STD_LOGIC := '0';
	 SIGNAL	niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_1_747q	:	STD_LOGIC := '0';
	 SIGNAL	niosii_system_cmd_xbar_mux_locked_0_11q	:	STD_LOGIC := '0';
	 SIGNAL	niosii_system_cmd_xbar_mux_locked_1_3q	:	STD_LOGIC := '0';
	 SIGNAL	niosii_system_cmd_xbar_mux_packet_in_progress_21q	:	STD_LOGIC := '0';
	 SIGNAL	niosii_system_cmd_xbar_mux_share_count_0_22q	:	STD_LOGIC := '0';
	 SIGNAL  wire_nO_w22w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL	wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_742m_dataout	:	STD_LOGIC;
	 SIGNAL	wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_743m_dataout	:	STD_LOGIC;
	 SIGNAL	wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_744m_dataout	:	STD_LOGIC;
	 SIGNAL	wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_745m_dataout	:	STD_LOGIC;
	 SIGNAL	wire_niosii_system_cmd_xbar_mux_p1_share_count_0_14m_dataout	:	STD_LOGIC;
	 SIGNAL  wire_niosii_system_cmd_xbar_mux_p1_share_count_0_14m_w_lg_dataout21w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL	wire_niosii_system_cmd_xbar_mux_packet_in_progress_10m_dataout	:	STD_LOGIC;
	 SIGNAL	wire_niosii_system_cmd_xbar_mux_packet_in_progress_9m_dataout	:	STD_LOGIC;
	 SIGNAL	wire_niosii_system_cmd_xbar_mux_share_count_17m_dataout	:	STD_LOGIC;
	 SIGNAL	wire_niosii_system_cmd_xbar_mux_share_count_19m_dataout	:	STD_LOGIC;
	 SIGNAL	wire_niosii_system_cmd_xbar_mux_share_count_zero_flag_18m_dataout	:	STD_LOGIC;
	 SIGNAL	wire_niosii_system_cmd_xbar_mux_share_count_zero_flag_20m_dataout	:	STD_LOGIC;
	 SIGNAL	wire_niosii_system_cmd_xbar_mux_update_grant_27m_dataout	:	STD_LOGIC;
	 SIGNAL  wire_niosii_system_cmd_xbar_mux_add0_13_a	:	STD_LOGIC_VECTOR (1 DOWNTO 0);
	 SIGNAL  wire_niosii_system_cmd_xbar_mux_add0_13_b	:	STD_LOGIC_VECTOR (1 DOWNTO 0);
	 SIGNAL  wire_gnd	:	STD_LOGIC;
	 SIGNAL  wire_niosii_system_cmd_xbar_mux_add0_13_o	:	STD_LOGIC_VECTOR (1 DOWNTO 0);
	 ...
	 SIGNAL  s_wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_altera_merlin_arb_adder_adder_cout_771_dataout :	STD_LOGIC;
	 SIGNAL  s_wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_altera_merlin_arb_adder_adder_full_adder_cout_0_768_dataout :	STD_LOGIC;
	 SIGNAL  s_wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_altera_merlin_arb_adder_adder_full_adder_cout_1_773_dataout :	STD_LOGIC;
	 SIGNAL  s_wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_grant_0_739_dataout :	STD_LOGIC;
	 SIGNAL  s_wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_grant_1_740_dataout :	STD_LOGIC;
	 SIGNAL  s_wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_wideor0_741_dataout :	STD_LOGIC;
	 SIGNAL  s_wire_niosii_system_cmd_xbar_mux_last_cycle_8_dataout :	STD_LOGIC;
	 SIGNAL  s_wire_niosii_system_cmd_xbar_mux_request_0_33_dataout :	STD_LOGIC;
	 SIGNAL  s_wire_niosii_system_cmd_xbar_mux_request_1_34_dataout :	STD_LOGIC;
	 SIGNAL  s_wire_niosii_system_cmd_xbar_mux_src_payload_0_265_dataout :	STD_LOGIC;
	 SIGNAL  s_wire_niosii_system_cmd_xbar_mux_src_payload_108_dataout :	STD_LOGIC;
	 SIGNAL  s_wire_niosii_system_cmd_xbar_mux_src_payload_220_dataout :	STD_LOGIC;
	 SIGNAL  s_wire_niosii_system_cmd_xbar_mux_wideor1_40_dataout :	STD_LOGIC;
	 SIGNAL  s_wire_vcc :	STD_LOGIC;
	 SIGNAL  wire_w_sink0_channel_range634w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 ...
	 SIGNAL  wire_w_sink1_channel_range636w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
 ...
 BEGIN
	...
	wire_gnd <= '0';
	wire_w_lg_w4w5w(0) <= wire_w4w(0) AND s_wire_niosii_system_cmd_xbar_mux_src_payload_0_265_dataout;
	wire_w_lg_w698w707w(0) <= wire_w698w(0) AND s_wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_altera_merlin_arb_adder_adder_full_adder_cout_1_773_dataout;
	wire_w_lg_w706w714w(0) <= wire_w706w(0) AND niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_1_747q;
	wire_w700w(0) <= s_wire_niosii_system_cmd_xbar_mux_request_0_33_dataout AND wire_w_lg_w698w699w(0);
	wire_w702w(0) <= s_wire_niosii_system_cmd_xbar_mux_request_0_33_dataout AND wire_w_lg_w698w701w(0);
	wire_w709w(0) <= s_wire_niosii_system_cmd_xbar_mux_request_1_34_dataout AND wire_w_lg_w706w708w(0);
	wire_w705w(0) <= s_wire_niosii_system_cmd_xbar_mux_request_1_34_dataout AND wire_w704w(0);
	wire_w4w(0) <= s_wire_niosii_system_cmd_xbar_mux_wideor1_40_dataout AND src_ready;
	wire_w_lg_reset3w(0) <= NOT reset;
	wire_w698w(0) <= NOT s_wire_niosii_system_cmd_xbar_mux_request_0_33_dataout;
	wire_w706w(0) <= NOT s_wire_niosii_system_cmd_xbar_mux_request_1_34_dataout;
	wire_w23w(0) <= NOT s_wire_niosii_system_cmd_xbar_mux_wideor1_40_dataout;
	wire_w6w(0) <= s_wire_niosii_system_cmd_xbar_mux_src_payload_108_dataout OR s_wire_niosii_system_cmd_xbar_mux_src_payload_220_dataout;
	wire_w_lg_w698w699w(0) <= wire_w698w(0) XOR niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_0_748q;
	wire_w_lg_w698w701w(0) <= wire_w698w(0) XOR s_wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_altera_merlin_arb_adder_adder_full_adder_cout_1_773_dataout;
	wire_w_lg_w706w708w(0) <= wire_w706w(0) XOR wire_w_lg_w698w707w(0);
	wire_w704w(0) <= s_wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_altera_merlin_arb_adder_adder_full_adder_cout_0_768_dataout XOR s_wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_altera_merlin_arb_adder_adder_cout_771_dataout;
	s_wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_altera_merlin_arb_adder_adder_cout_771_dataout <= (wire_w706w(0) XOR niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_1_747q);
	s_wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_altera_merlin_arb_adder_adder_full_adder_cout_0_768_dataout <= (wire_w698w(0) AND niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_0_748q);
	s_wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_altera_merlin_arb_adder_adder_full_adder_cout_1_773_dataout <= (wire_w_lg_w706w714w(0) OR (s_wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_altera_merlin_arb_adder_adder_full_adder_cout_0_768_dataout AND s_wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_altera_merlin_arb_adder_adder_cout_771_dataout));
	s_wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_grant_0_739_dataout <= (wire_w700w(0) OR wire_w702w(0));
	s_wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_grant_1_740_dataout <= (wire_w705w(0) OR wire_w709w(0));
	s_wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_wideor0_741_dataout <= (s_wire_niosii_system_cmd_xbar_mux_request_0_33_dataout OR s_wire_niosii_system_cmd_xbar_mux_request_1_34_dataout);
	s_wire_niosii_system_cmd_xbar_mux_last_cycle_8_dataout <= (wire_w_lg_w4w5w(0) AND (NOT wire_w6w(0)));
	s_wire_niosii_system_cmd_xbar_mux_request_0_33_dataout <= (niosii_system_cmd_xbar_mux_locked_0_11q OR sink0_valid);
	s_wire_niosii_system_cmd_xbar_mux_request_1_34_dataout <= (niosii_system_cmd_xbar_mux_locked_1_3q OR sink1_valid);
	s_wire_niosii_system_cmd_xbar_mux_src_payload_0_265_dataout <= ((niosii_system_cmd_xbar_mux_saved_grant_0_32q AND sink0_endofpacket) OR (niosii_system_cmd_xbar_mux_saved_grant_1_31q AND sink1_endofpacket));
	s_wire_niosii_system_cmd_xbar_mux_src_payload_108_dataout <= (niosii_system_cmd_xbar_mux_saved_grant_0_32q AND sink0_data(65));
	s_wire_niosii_system_cmd_xbar_mux_src_payload_220_dataout <= (niosii_system_cmd_xbar_mux_saved_grant_1_31q AND sink1_data(65));
	s_wire_niosii_system_cmd_xbar_mux_wideor1_40_dataout <= ((niosii_system_cmd_xbar_mux_saved_grant_0_32q AND sink0_valid) OR (niosii_system_cmd_xbar_mux_saved_grant_1_31q AND sink1_valid));
	s_wire_vcc <= '1';
	sink0_ready <= (niosii_system_cmd_xbar_mux_saved_grant_0_32q AND src_ready);
	sink1_ready <= (niosii_system_cmd_xbar_mux_saved_grant_1_31q AND src_ready);
	src_channel <= ( wire_ni_w_lg_w690w693w & wire_ni_w_lg_w684w687w & wire_ni_w_lg_w678w681w & wire_ni_w_lg_w672w675w & wire_ni_w_lg_w666w669w & wire_ni_w_lg_w660w663w & wire_ni_w_lg_w654w657w & wire_ni_w_lg_w648w651w & wire_ni_w_lg_w642w645w & wire_ni_w_lg_w635w638w);
	src_data <= ( wire_ni_w_lg_w629w632w & wire_ni_w_lg_w623w626w & wire_ni_w_lg_w617w620w & wire_ni_w_lg_w611w614w & wire_ni_w_lg_w605w608w & wire_ni_w_lg_w599w602w & wire_ni_w_lg_w593w596w & wire_ni_w_lg_w587w590w & wire_ni_w_lg_w581w584w & wire_ni_w_lg_w575w578w & wire_ni_w_lg_w569w572w & wire_ni_w_lg_w563w566w & wire_ni_w_lg_w557w560w & wire_ni_w_lg_w551w554w & wire_ni_w_lg_w545w548w & wire_ni_w_lg_w539w542w & wire_ni_w_lg_w533w536w & wire_ni_w_lg_w527w530w & wire_ni_w_lg_w521w524w & wire_ni_w_lg_w515w518w & wire_ni_w_lg_w509w512w & wire_ni_w_lg_w503w506w & wire_ni_w_lg_w497w500w & wire_ni_w_lg_w491w494w & wire_ni_w_lg_w485w488w & wire_ni_w_lg_w479w482w & wire_ni_w_lg_w473w476w & wire_ni_w_lg_w467w470w & wire_ni_w_lg_w461w464w & wire_ni_w_lg_w455w458w & wire_ni_w_lg_w449w452w & wire_ni_w_lg_w443w446w & wire_ni_w_lg_w437w440w & wire_ni_w_lg_w431w434w & wire_w6w & wire_ni_w_lg_w424w427w & wire_ni_w_lg_w418w421w & wire_ni_w_lg_w412w415w & wire_ni_w_lg_w406w409w & wire_ni_w_lg_w400w403w & wire_ni_w_lg_w394w397w & wire_ni_w_lg_w388w391w & wire_ni_w_lg_w382w385w & wire_ni_w_lg_w376w379w & wire_ni_w_lg_w370w373w & wire_ni_w_lg_w364w367w & wire_ni_w_lg_w358w361w & wire_ni_w_lg_w352w355w & wire_ni_w_lg_w346w349w & wire_ni_w_lg_w340w343w & wire_ni_w_lg_w334w337w & wire_ni_w_lg_w328w331w & wire_ni_w_lg_w322w325w & wire_ni_w_lg_w316w319w & wire_ni_w_lg_w310w313w & wire_ni_w_lg_w304w307w & wire_ni_w_lg_w298w301w & wire_ni_w_lg_w292w295w & wire_ni_w_lg_w286w289w & wire_ni_w_lg_w280w283w & wire_ni_w_lg_w274w277w & wire_ni_w_lg_w268w271w & wire_ni_w_lg_w262w265w & wire_ni_w_lg_w256w259w & wire_ni_w_lg_w250w253w & wire_ni_w_lg_w244w247w & wire_ni_w_lg_w238w241w & wire_ni_w_lg_w232w235w & wire_ni_w_lg_w226w229w & wire_ni_w_lg_w220w223w & wire_ni_w_lg_w214w217w & wire_ni_w_lg_w208w211w & wire_ni_w_lg_w202w205w & wire_ni_w_lg_w196w199w & wire_ni_w_lg_w190w193w & wire_ni_w_lg_w184w187w & wire_ni_w_lg_w178w181w & wire_ni_w_lg_w172w175w & wire_ni_w_lg_w166w169w & wire_ni_w_lg_w160w163w & wire_ni_w_lg_w154w157w & wire_ni_w_lg_w148w151w
 & wire_ni_w_lg_w142w145w & wire_ni_w_lg_w136w139w & wire_ni_w_lg_w130w133w & wire_ni_w_lg_w124w127w & wire_ni_w_lg_w118w121w & wire_ni_w_lg_w112w115w & wire_ni_w_lg_w106w109w & wire_ni_w_lg_w100w103w & wire_ni_w_lg_w94w97w & wire_ni_w_lg_w88w91w & wire_ni_w_lg_w82w85w & wire_ni_w_lg_w76w79w & wire_ni_w_lg_w70w73w & wire_ni_w_lg_w64w67w & wire_ni_w_lg_w58w61w & wire_ni_w_lg_w52w55w & wire_ni_w_lg_w46w49w & wire_ni_w_lg_w39w42w);
	src_endofpacket <= s_wire_niosii_system_cmd_xbar_mux_src_payload_0_265_dataout;
	src_startofpacket <= ((niosii_system_cmd_xbar_mux_saved_grant_0_32q AND sink0_startofpacket) OR (niosii_system_cmd_xbar_mux_saved_grant_1_31q AND sink1_startofpacket));
	src_valid <= s_wire_niosii_system_cmd_xbar_mux_wideor1_40_dataout;
	wire_w_sink0_channel_range634w(0) <= sink0_channel(0);
	wire_w_sink0_channel_range641w(0) <= sink0_channel(1);
	wire_w_sink0_channel_range647w(0) <= sink0_channel(2);
	wire_w_sink0_channel_range653w(0) <= sink0_channel(3);
	wire_w_sink0_channel_range659w(0) <= sink0_channel(4);
	wire_w_sink0_channel_range665w(0) <= sink0_channel(5);
	wire_w_sink0_channel_range671w(0) <= sink0_channel(6);
	wire_w_sink0_channel_range677w(0) <= sink0_channel(7);
	wire_w_sink0_channel_range683w(0) <= sink0_channel(8);
	wire_w_sink0_channel_range689w(0) <= sink0_channel(9);
	...
	wire_w_sink1_channel_range636w(0) <= sink1_channel(0);
	wire_w_sink1_channel_range643w(0) <= sink1_channel(1);
	wire_w_sink1_channel_range649w(0) <= sink1_channel(2);
	wire_w_sink1_channel_range655w(0) <= sink1_channel(3);
	wire_w_sink1_channel_range661w(0) <= sink1_channel(4);
	wire_w_sink1_channel_range667w(0) <= sink1_channel(5);
	wire_w_sink1_channel_range673w(0) <= sink1_channel(6);
	wire_w_sink1_channel_range679w(0) <= sink1_channel(7);
	wire_w_sink1_channel_range685w(0) <= sink1_channel(8);
	wire_w_sink1_channel_range691w(0) <= sink1_channel(9);
	...
	BEGIN
		IF (reset = '1') THEN
				niosii_system_cmd_xbar_mux_saved_grant_0_32q <= '0';
				niosii_system_cmd_xbar_mux_saved_grant_1_31q <= '0';
		ELSIF (clk = '1' AND clk'event) THEN
			IF (wire_niosii_system_cmd_xbar_mux_update_grant_27m_dataout = '1') THEN
				niosii_system_cmd_xbar_mux_saved_grant_0_32q <= s_wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_grant_0_739_dataout;
				niosii_system_cmd_xbar_mux_saved_grant_1_31q <= s_wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_grant_1_740_dataout;
			END IF;
		END IF;
	END PROCESS;
	wire_ni_w635w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_channel_range634w(0);
	wire_ni_w642w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_channel_range641w(0);
	wire_ni_w648w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_channel_range647w(0);
	wire_ni_w654w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_channel_range653w(0);
	wire_ni_w660w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_channel_range659w(0);
	wire_ni_w666w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_channel_range665w(0);
	wire_ni_w672w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_channel_range671w(0);
	wire_ni_w678w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_channel_range677w(0);
	wire_ni_w684w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_channel_range683w(0);
	wire_ni_w690w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_channel_range689w(0);
	wire_ni_w39w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range38w(0);
	wire_ni_w100w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range99w(0);
	wire_ni_w106w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range105w(0);
	wire_ni_w112w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range111w(0);
	wire_ni_w118w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range117w(0);
	wire_ni_w124w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range123w(0);
	wire_ni_w130w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range129w(0);
	wire_ni_w136w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range135w(0);
	wire_ni_w142w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range141w(0);
	wire_ni_w148w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range147w(0);
	wire_ni_w154w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range153w(0);
	wire_ni_w46w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range45w(0);
	wire_ni_w160w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range159w(0);
	wire_ni_w166w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range165w(0);
	wire_ni_w172w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range171w(0);
	wire_ni_w178w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range177w(0);
	wire_ni_w184w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range183w(0);
	wire_ni_w190w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range189w(0);
	wire_ni_w196w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range195w(0);
	wire_ni_w202w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range201w(0);
	wire_ni_w208w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range207w(0);
	wire_ni_w214w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range213w(0);
	wire_ni_w52w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range51w(0);
	wire_ni_w220w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range219w(0);
	wire_ni_w226w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range225w(0);
	wire_ni_w232w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range231w(0);
	wire_ni_w238w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range237w(0);
	wire_ni_w244w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range243w(0);
	wire_ni_w250w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range249w(0);
	wire_ni_w256w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range255w(0);
	wire_ni_w262w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range261w(0);
	wire_ni_w268w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range267w(0);
	wire_ni_w274w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range273w(0);
	wire_ni_w58w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range57w(0);
	wire_ni_w280w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range279w(0);
	wire_ni_w286w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range285w(0);
	wire_ni_w292w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range291w(0);
	wire_ni_w298w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range297w(0);
	wire_ni_w304w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range303w(0);
	wire_ni_w310w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range309w(0);
	wire_ni_w316w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range315w(0);
	wire_ni_w322w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range321w(0);
	wire_ni_w328w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range327w(0);
	wire_ni_w334w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range333w(0);
	wire_ni_w64w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range63w(0);
	wire_ni_w340w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range339w(0);
	wire_ni_w346w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range345w(0);
	wire_ni_w352w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range351w(0);
	wire_ni_w358w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range357w(0);
	wire_ni_w364w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range363w(0);
	wire_ni_w370w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range369w(0);
	wire_ni_w376w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range375w(0);
	wire_ni_w382w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range381w(0);
	wire_ni_w388w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range387w(0);
	wire_ni_w394w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range393w(0);
	wire_ni_w70w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range69w(0);
	wire_ni_w400w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range399w(0);
	wire_ni_w406w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range405w(0);
	wire_ni_w412w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range411w(0);
	wire_ni_w418w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range417w(0);
	wire_ni_w424w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range423w(0);
	wire_ni_w431w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range430w(0);
	wire_ni_w437w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range436w(0);
	wire_ni_w443w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range442w(0);
	wire_ni_w449w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range448w(0);
	wire_ni_w76w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range75w(0);
	wire_ni_w455w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range454w(0);
	wire_ni_w461w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range460w(0);
	wire_ni_w467w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range466w(0);
	wire_ni_w473w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range472w(0);
	wire_ni_w479w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range478w(0);
	wire_ni_w485w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range484w(0);
	wire_ni_w491w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range490w(0);
	wire_ni_w497w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range496w(0);
	wire_ni_w503w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range502w(0);
	wire_ni_w509w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range508w(0);
	wire_ni_w82w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range81w(0);
	wire_ni_w515w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range514w(0);
	wire_ni_w521w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range520w(0);
	wire_ni_w527w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range526w(0);
	wire_ni_w533w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range532w(0);
	wire_ni_w539w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range538w(0);
	wire_ni_w545w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range544w(0);
	wire_ni_w551w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range550w(0);
	wire_ni_w557w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range556w(0);
	wire_ni_w563w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range562w(0);
	wire_ni_w569w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range568w(0);
	wire_ni_w88w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range87w(0);
	wire_ni_w575w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range574w(0);
	wire_ni_w581w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range580w(0);
	wire_ni_w587w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range586w(0);
	wire_ni_w593w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range592w(0);
	wire_ni_w599w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range598w(0);
	wire_ni_w605w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range604w(0);
	wire_ni_w611w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range610w(0);
	wire_ni_w617w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range616w(0);
	wire_ni_w623w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range622w(0);
	wire_ni_w629w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range628w(0);
	wire_ni_w94w(0) <= niosii_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range93w(0);
	wire_ni_w637w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_channel_range636w(0);
	wire_ni_w644w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_channel_range643w(0);
	wire_ni_w650w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_channel_range649w(0);
	wire_ni_w656w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_channel_range655w(0);
	wire_ni_w662w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_channel_range661w(0);
	wire_ni_w668w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_channel_range667w(0);
	wire_ni_w674w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_channel_range673w(0);
	wire_ni_w680w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_channel_range679w(0);
	wire_ni_w686w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_channel_range685w(0);
	wire_ni_w692w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_channel_range691w(0);
	wire_ni_w41w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range40w(0);
	wire_ni_w102w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range101w(0);
	wire_ni_w108w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range107w(0);
	wire_ni_w114w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range113w(0);
	wire_ni_w120w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range119w(0);
	wire_ni_w126w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range125w(0);
	wire_ni_w132w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range131w(0);
	wire_ni_w138w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range137w(0);
	wire_ni_w144w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range143w(0);
	wire_ni_w150w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range149w(0);
	wire_ni_w156w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range155w(0);
	wire_ni_w48w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range47w(0);
	wire_ni_w162w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range161w(0);
	wire_ni_w168w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range167w(0);
	wire_ni_w174w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range173w(0);
	wire_ni_w180w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range179w(0);
	wire_ni_w186w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range185w(0);
	wire_ni_w192w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range191w(0);
	wire_ni_w198w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range197w(0);
	wire_ni_w204w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range203w(0);
	wire_ni_w210w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range209w(0);
	wire_ni_w216w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range215w(0);
	wire_ni_w54w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range53w(0);
	wire_ni_w222w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range221w(0);
	wire_ni_w228w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range227w(0);
	wire_ni_w234w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range233w(0);
	wire_ni_w240w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range239w(0);
	wire_ni_w246w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range245w(0);
	wire_ni_w252w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range251w(0);
	wire_ni_w258w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range257w(0);
	wire_ni_w264w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range263w(0);
	wire_ni_w270w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range269w(0);
	wire_ni_w276w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range275w(0);
	wire_ni_w60w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range59w(0);
	wire_ni_w282w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range281w(0);
	wire_ni_w288w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range287w(0);
	wire_ni_w294w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range293w(0);
	wire_ni_w300w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range299w(0);
	wire_ni_w306w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range305w(0);
	wire_ni_w312w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range311w(0);
	wire_ni_w318w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range317w(0);
	wire_ni_w324w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range323w(0);
	wire_ni_w330w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range329w(0);
	wire_ni_w336w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range335w(0);
	wire_ni_w66w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range65w(0);
	wire_ni_w342w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range341w(0);
	wire_ni_w348w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range347w(0);
	wire_ni_w354w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range353w(0);
	wire_ni_w360w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range359w(0);
	wire_ni_w366w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range365w(0);
	wire_ni_w372w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range371w(0);
	wire_ni_w378w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range377w(0);
	wire_ni_w384w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range383w(0);
	wire_ni_w390w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range389w(0);
	wire_ni_w396w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range395w(0);
	wire_ni_w72w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range71w(0);
	wire_ni_w402w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range401w(0);
	wire_ni_w408w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range407w(0);
	wire_ni_w414w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range413w(0);
	wire_ni_w420w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range419w(0);
	wire_ni_w426w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range425w(0);
	wire_ni_w433w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range432w(0);
	wire_ni_w439w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range438w(0);
	wire_ni_w445w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range444w(0);
	wire_ni_w451w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range450w(0);
	wire_ni_w78w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range77w(0);
	wire_ni_w457w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range456w(0);
	wire_ni_w463w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range462w(0);
	wire_ni_w469w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range468w(0);
	wire_ni_w475w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range474w(0);
	wire_ni_w481w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range480w(0);
	wire_ni_w487w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range486w(0);
	wire_ni_w493w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range492w(0);
	wire_ni_w499w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range498w(0);
	wire_ni_w505w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range504w(0);
	wire_ni_w511w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range510w(0);
	wire_ni_w84w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range83w(0);
	wire_ni_w517w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range516w(0);
	wire_ni_w523w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range522w(0);
	wire_ni_w529w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range528w(0);
	wire_ni_w535w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range534w(0);
	wire_ni_w541w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range540w(0);
	wire_ni_w547w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range546w(0);
	wire_ni_w553w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range552w(0);
	wire_ni_w559w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range558w(0);
	wire_ni_w565w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range564w(0);
	wire_ni_w571w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range570w(0);
	wire_ni_w90w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range89w(0);
	wire_ni_w577w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range576w(0);
	wire_ni_w583w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range582w(0);
	wire_ni_w589w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range588w(0);
	wire_ni_w595w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range594w(0);
	wire_ni_w601w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range600w(0);
	wire_ni_w607w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range606w(0);
	wire_ni_w613w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range612w(0);
	wire_ni_w619w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range618w(0);
	wire_ni_w625w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range624w(0);
	wire_ni_w631w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range630w(0);
	wire_ni_w96w(0) <= niosii_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range95w(0);
	...
	BEGIN
		IF (reset = '1') THEN
				niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_0_748q <= '1';
				niosii_system_cmd_xbar_mux_share_count_zero_flag_30q <= '1';
		ELSIF (clk = '1' AND clk'event) THEN
				niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_0_748q <= wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_745m_dataout;
				niosii_system_cmd_xbar_mux_share_count_zero_flag_30q <= wire_niosii_system_cmd_xbar_mux_share_count_zero_flag_20m_dataout;
		END IF;
	END PROCESS;
	PROCESS (clk, reset)
	BEGIN
		IF (reset = '1') THEN
				niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_1_747q <= '0';
				niosii_system_cmd_xbar_mux_locked_0_11q <= '0';
				niosii_system_cmd_xbar_mux_locked_1_3q <= '0';
				niosii_system_cmd_xbar_mux_packet_in_progress_21q <= '0';
				niosii_system_cmd_xbar_mux_share_count_0_22q <= '0';
		ELSIF (clk = '1' AND clk'event) THEN
				niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_1_747q <= wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_744m_dataout;
				niosii_system_cmd_xbar_mux_locked_0_11q <= (sink0_data(65) AND s_wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_grant_0_739_dataout);
				niosii_system_cmd_xbar_mux_locked_1_3q <= (sink1_data(65) AND s_wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_grant_1_740_dataout);
				niosii_system_cmd_xbar_mux_packet_in_progress_21q <= wire_niosii_system_cmd_xbar_mux_packet_in_progress_10m_dataout;
				niosii_system_cmd_xbar_mux_share_count_0_22q <= wire_niosii_system_cmd_xbar_mux_share_count_19m_dataout;
		END IF;
	END PROCESS;
	wire_nO_w22w(0) <= NOT niosii_system_cmd_xbar_mux_packet_in_progress_21q;
	wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_742m_dataout <= s_wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_grant_0_739_dataout WHEN s_wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_wideor0_741_dataout = '1'  ELSE niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_1_747q;
	wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_743m_dataout <= s_wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_grant_1_740_dataout WHEN s_wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_wideor0_741_dataout = '1'  ELSE niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_0_748q;
	wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_744m_dataout <= wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_742m_dataout WHEN wire_niosii_system_cmd_xbar_mux_update_grant_27m_dataout = '1'  ELSE niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_1_747q;
	wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_745m_dataout <= wire_niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_743m_dataout WHEN wire_niosii_system_cmd_xbar_mux_update_grant_27m_dataout = '1'  ELSE niosii_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_0_748q;
	wire_niosii_system_cmd_xbar_mux_p1_share_count_0_14m_dataout <= wire_niosii_system_cmd_xbar_mux_add0_13_o(1) AND NOT(niosii_system_cmd_xbar_mux_share_count_zero_flag_30q);
	wire_niosii_system_cmd_xbar_mux_p1_share_count_0_14m_w_lg_dataout21w(0) <= NOT wire_niosii_system_cmd_xbar_mux_p1_share_count_0_14m_dataout;
	wire_niosii_system_cmd_xbar_mux_packet_in_progress_10m_dataout <= wire_niosii_system_cmd_xbar_mux_packet_in_progress_9m_dataout AND NOT(s_wire_niosii_system_cmd_xbar_mux_last_cycle_8_dataout);
	wire_niosii_system_cmd_xbar_mux_packet_in_progress_9m_dataout <= niosii_system_cmd_xbar_mux_packet_in_progress_21q OR s_wire_niosii_system_cmd_xbar_mux_wideor1_40_dataout;
	wire_niosii_system_cmd_xbar_mux_share_count_17m_dataout <= wire_niosii_system_cmd_xbar_mux_p1_share_count_0_14m_dataout WHEN s_wire_niosii_system_cmd_xbar_mux_last_cycle_8_dataout = '1'  ELSE niosii_system_cmd_xbar_mux_share_count_0_22q;
	wire_niosii_system_cmd_xbar_mux_share_count_19m_dataout <= wire_niosii_system_cmd_xbar_mux_share_count_17m_dataout AND NOT(wire_niosii_system_cmd_xbar_mux_update_grant_27m_dataout);
	wire_niosii_system_cmd_xbar_mux_share_count_zero_flag_18m_dataout <= wire_niosii_system_cmd_xbar_mux_p1_share_count_0_14m_w_lg_dataout21w(0) WHEN s_wire_niosii_system_cmd_xbar_mux_last_cycle_8_dataout = '1'  ELSE niosii_system_cmd_xbar_mux_share_count_zero_flag_30q;
	wire_niosii_system_cmd_xbar_mux_share_count_zero_flag_20m_dataout <= wire_niosii_system_cmd_xbar_mux_share_count_zero_flag_18m_dataout OR wire_niosii_system_cmd_xbar_mux_update_grant_27m_dataout;
	wire_niosii_system_cmd_xbar_mux_update_grant_27m_dataout <= (wire_nO_w22w(0) AND wire_w23w(0)) OR (s_wire_niosii_system_cmd_xbar_mux_last_cycle_8_dataout AND niosii_system_cmd_xbar_mux_share_count_zero_flag_30q);
	wire_niosii_system_cmd_xbar_mux_add0_13_a <= ( niosii_system_cmd_xbar_mux_share_count_0_22q & "1");
	wire_niosii_system_cmd_xbar_mux_add0_13_b <= ( "0" & "1");
	niosii_system_cmd_xbar_mux_add0_13 :  oper_add
	  GENERIC MAP (
	  ...
	  PORT MAP ( 
		a => wire_niosii_system_cmd_xbar_mux_add0_13_a,
		b => wire_niosii_system_cmd_xbar_mux_add0_13_b,
		cin => wire_gnd,
		o => wire_niosii_system_cmd_xbar_mux_add0_13_o
	  );

 END RTL; --niosII_system_cmd_xbar_mux
