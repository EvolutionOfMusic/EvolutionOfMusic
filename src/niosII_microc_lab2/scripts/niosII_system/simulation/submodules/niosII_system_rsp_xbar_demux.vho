...
--synthesis_resources = 
 ...
 ENTITY  niosII_system_rsp_xbar_demux IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END niosII_system_rsp_xbar_demux;

 ARCHITECTURE RTL OF niosII_system_rsp_xbar_demux IS
 ...
 END RTL; --niosII_system_rsp_xbar_demux
