...
--synthesis_resources = 
 ...
 ENTITY  niosII_system_rsp_xbar_demux_006 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END niosII_system_rsp_xbar_demux_006;

 ARCHITECTURE RTL OF niosII_system_rsp_xbar_demux_006 IS
 ...
 END RTL; --niosII_system_rsp_xbar_demux_006
