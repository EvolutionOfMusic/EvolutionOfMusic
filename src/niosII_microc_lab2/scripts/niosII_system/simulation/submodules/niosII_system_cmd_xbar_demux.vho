...
--synthesis_resources = 
 ...
 ENTITY  niosII_system_cmd_xbar_demux IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END niosII_system_cmd_xbar_demux;

 ARCHITECTURE RTL OF niosII_system_cmd_xbar_demux IS
	 ...
	 SIGNAL  s_wire_niosii_system_cmd_xbar_demux_wideor0_13_dataout :	STD_LOGIC;
 ...
 BEGIN
	...
	s_wire_niosii_system_cmd_xbar_demux_wideor0_13_dataout <= (((((wire_w_lg_w_sink_channel_range1w2w(0) OR wire_w_lg_w_sink_channel_range3w4w(0)) OR wire_w_lg_w_sink_channel_range6w7w(0)) OR wire_w_lg_w_sink_channel_range9w10w(0)) OR wire_w_lg_w_sink_channel_range12w13w(0)) OR wire_w_lg_w_sink_channel_range15w16w(0));
	sink_ready <= s_wire_niosii_system_cmd_xbar_demux_wideor0_13_dataout;
	src0_channel <= ( "0" & "0" & "0" & "0" & "0" & "0" & sink_channel(9 DOWNTO 6));
	src0_data <= ( sink_data(99 DOWNTO 0));
	src0_endofpacket <= sink_endofpacket;
	src0_startofpacket <= sink_startofpacket;
	src0_valid <= (sink_valid(0) AND sink_channel(0));
	src1_channel <= ( "0" & "0" & "0" & "0" & "0" & "0" & sink_channel(9 DOWNTO 6));
	src1_data <= ( sink_data(99 DOWNTO 0));
	src1_endofpacket <= sink_endofpacket;
	src1_startofpacket <= sink_startofpacket;
	src1_valid <= (sink_valid(0) AND sink_channel(1));
	src2_channel <= ( "0" & "0" & "0" & "0" & "0" & "0" & sink_channel(9 DOWNTO 6));
	src2_data <= ( sink_data(99 DOWNTO 0));
	src2_endofpacket <= sink_endofpacket;
	src2_startofpacket <= sink_startofpacket;
	src2_valid <= (sink_valid(0) AND sink_channel(2));
	src3_channel <= ( "0" & "0" & "0" & "0" & "0" & "0" & sink_channel(9 DOWNTO 6));
	src3_data <= ( sink_data(99 DOWNTO 0));
	src3_endofpacket <= sink_endofpacket;
	src3_startofpacket <= sink_startofpacket;
	src3_valid <= (sink_valid(0) AND sink_channel(3));
	src4_channel <= ( "0" & "0" & "0" & "0" & "0" & "0" & sink_channel(9 DOWNTO 6));
	src4_data <= ( sink_data(99 DOWNTO 0));
	src4_endofpacket <= sink_endofpacket;
	src4_startofpacket <= sink_startofpacket;
	src4_valid <= (sink_valid(0) AND sink_channel(4));
	src5_channel <= ( "0" & "0" & "0" & "0" & "0" & "0" & sink_channel(9 DOWNTO 6));
 ...
 END RTL; --niosII_system_cmd_xbar_demux
