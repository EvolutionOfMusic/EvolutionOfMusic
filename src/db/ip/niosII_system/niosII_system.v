...
// Generated using ACDS version 12.1sp1 243 at 2016.03.23.14:17:02
...
module niosII_system (
	...
	wire          rst_controller_003_reset_out_reset;                                                                                   // rst_controller_003:reset_out -> [cmd_xbar_mux_005:reset, crosser:out_reset, crosser_001:out_reset, crosser_002:in_reset, crosser_003:in_reset, id_router_005:reset, rsp_xbar_demux_005:reset, synthesizer_0:reset_n, synthesizer_0_voice_select_translator:reset, synthesizer_0_voice_select_translator_avalon_universal_slave_0_agent:reset, synthesizer_0_voice_select_translator_avalon_universal_slave_0_agent_rsp_fifo:reset]
	...
	wire   [10:0] cmd_xbar_demux_src5_channel;                                                                                          // cmd_xbar_demux:src5_channel -> crosser:in_channel
	...
	wire   [99:0] crosser_001_out_data;                                                                                                 // crosser_001:out_data -> cmd_xbar_mux_005:sink1_data
	wire   [10:0] crosser_001_out_channel;                                                                                              // crosser_001:out_channel -> cmd_xbar_mux_005:sink1_channel
	...
	wire   [99:0] cmd_xbar_demux_001_src5_data;                                                                                         // cmd_xbar_demux_001:src5_data -> crosser_001:in_data
	wire   [10:0] cmd_xbar_demux_001_src5_channel;                                                                                      // cmd_xbar_demux_001:src5_channel -> crosser_001:in_channel
	...
	wire   [99:0] crosser_002_out_data;                                                                                                 // crosser_002:out_data -> rsp_xbar_mux:sink5_data
	wire   [10:0] crosser_002_out_channel;                                                                                              // crosser_002:out_channel -> rsp_xbar_mux:sink5_channel
	...
	wire   [99:0] rsp_xbar_demux_005_src0_data;                                                                                         // rsp_xbar_demux_005:src0_data -> crosser_002:in_data
	wire   [10:0] rsp_xbar_demux_005_src0_channel;                                                                                      // rsp_xbar_demux_005:src0_channel -> crosser_002:in_channel
	...
	wire   [99:0] rsp_xbar_demux_005_src1_data;                                                                                         // rsp_xbar_demux_005:src1_data -> crosser_003:in_data
	wire   [10:0] rsp_xbar_demux_005_src1_channel;                                                                                      // rsp_xbar_demux_005:src1_channel -> crosser_003:in_channel
	...
	SynthesizerTopLevel synthesizer_0 (
		...
		.aso_data_audio_out          (synthesizer_0_audio_data),                                            //        audio.data
		.aso_valid_audio_out         (synthesizer_0_audio_valid),                                           //             .valid
		.aso_startofpacket_audio_out (),                                                                    //             .startofpacket
		.aso_endofpacket_audio_out   (),                                                                    //             .endofpacket
		.aso_error_audio_out         (),                                                                    //             .error
		.aso_ready_audio_in          (synthesizer_0_audio_ready),                                           //             .ready
		.aso_empty_audio_out         (),                                                                    //             .empty
		.csi_clk50M                  (),                                                                    //    clock_50M.clk
		.csi_clk32k                  ()                                                                     //    clock_32k.clk
	);
